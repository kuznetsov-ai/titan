...
Репозиторий: <https://github.com/kuznetsov-ai/titan>
...
```bash
git clone https://github.com/kuznetsov-ai/titan.git
cd titan
python -m venv .venv
...
Пароли и логины в `config/systems/*.yaml` берутся из env-переменных:

```bash
export TITAN_USERNAME="your-login"
export TITAN_PASSWORD="your-password"
```
